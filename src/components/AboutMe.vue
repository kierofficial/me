  ...
  <div class="max-w-7xl m-center pt-20 pb-20">
    ...
    >
      ...
      >
        ...
        >
          Experienced software developer with a passion for developing innovative programs that boost the efficiency and effectiveness of organizational success. Well-versed in technology and able to write code to construct dependable and user-friendly solutions. Confident communicator, strategic thinker, and innovative creator to develop software that is customized to meet a company's organizational needs, highlight its core competencies, and further its success.
        </div>
        <div
